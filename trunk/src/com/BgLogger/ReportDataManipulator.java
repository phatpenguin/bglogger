...
public class ReportDataManipulator
{
    ...
    public ReportDataManipulator(Context context) {
    	ReportDataManipulator.context = context;
        OpenHelper openHelper = new OpenHelper(ReportDataManipulator.context);
        ReportDataManipulator.db = openHelper.getWritableDatabase();
        this.insertStmt = ReportDataManipulator.db.compileStatement(INSERT);
    }
